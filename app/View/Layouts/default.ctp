        ...
        <table>
            <tr>
                ...
                <td align="right">
                    <b>Newsletter</b><br>
                    <?php
                    echo $this->form->create('Newsletter', array('action'=>'add'));
                    echo $this->form->input('email', array('type'=>'email', 'label'=>false, 'required'=>true, 'div'=>false ));
                    echo $this->form->submit('Sign up', array('id'=>'signup-button', 'div'=>false));
                    echo $this->form->end();
                    ?>
                </td>
            </tr>
